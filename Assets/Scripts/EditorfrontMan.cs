...
public class EditorfrontMan : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //NOTE!  NOTE!  DO (((NOT)))  USE  CTRL Z WHILE IN THE EDITOR-PLAY MODE!!!!  IT WILL PROC A CTRL+Z ON THE EDITOR ITSELF!!!

        //BUILD AND RUN TO TEST CTRL Z!!!!!!!!!!!!!!!!!!!!!!!!!!!!

        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

        if (Input.GetKeyDown(KeyCode.Z))
        {//CTRL+Z SELECTS UNDO ------- this is gonna be a bitch and a half to impliment
        ...
        {//this just lets the user press z then ctrl, rather than ctrl then z
