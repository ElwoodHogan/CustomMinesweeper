...
public class CameraAI : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(Input.mouseScrollDelta.y !=0  && Application.isFocused) cam.orthographicSize = Mathf.Clamp(cam.orthographicSize - ((Input.mouseScrollDelta.y / 1.5f) * SettingMenuAI.SM.GetSS()), 2, SettingMenuAI.SM.GetCC() ? 20:999);
